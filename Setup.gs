...
function initializeDatabase() {
  ...
  const schema = {
    ...
    "Appointments": [
      ["ApptID", "CustomerName", "Phone", "Date", "Time", "Services", "Staff", "Duration", "Status", "Notes", "AdvancePaid", "AdvanceMethod"],
      ["A001", "Ayesha Khan", "03001234567", "2026-07-11", "14:00", "Signature Facial", "Maria", "60", "Confirmed", "Prefers gentle circular massage style", "0", "None"],
      ["A002", "Zainab Malik", "03217654321", "2026-07-11", "16:30", "Hair Cut & Style", "Sana", "45", "Pending", "Wants bob cut, medium length", "0", "None"]
    ],
    "Suppliers": [
